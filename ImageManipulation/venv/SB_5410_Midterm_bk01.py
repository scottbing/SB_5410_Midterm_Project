...
class Application(Frame):
    ...
    def create_widgets(self):
        ...
        #
        # Scrollbar(self).grid(row=1, column=1, sticky="nse")  # set this to column=2 so it sits in the correct spot.
        #
        # # Show an image
        # self.image = Image.open('bakery.jpeg')
        # self.photo = ImageTk.PhotoImage(self.image)
        # self.imglbl = Label(self, image=self.photo)
        # self.imglbl.grid(row=1, column=0, columnspan=4, sticky="nsew")
